...
!(function () {
    var LobiboxNotify = function (type, options) {
        ...
        (this.remove = function () {
            if (!me.$el || typeof me.$el.removeClass !== "function") {
                return me;
            }
            ...
            try {
                ...
                if (!parent || typeof parent.closest !== "function") return me;

                var wrapper = parent.closest(".lobibox-notify-wrapper-large") || parent.closest(".lobibox-notify-wrapper"),
                    href = "#" + parent.attr("id"),
                    $li = wrapper && wrapper.find
                        ? wrapper.find('>.lb-notify-tabs>li:has(a[href="' + href + '"])')
                        : $();
                ...
                setTimeout(function () {
                    if (me.$el && (me.$options.size === "normal" || me.$options.size === "mini")) {
                        try {
                    ...
                    } else if (me.$options.size === "large" && $li && parent) {
                ...
                console.warn("Error al ejecutar remove() en Lobibox:", error);
            }
            ...
            (me._init = function () {
                ...
                me.$el = $notify; // 🔥 Línea crucial para que funcione el remove()
                if (
                ...
                if (me.$options.sound && typeof me.$options.sound === "string" && me.$options.sound.trim() !== "") {
                    try {
                        ...
                        console.warn("Error al crear o reproducir sonido:", error);
                    }
                }
    ...
    (Lobibox.notify = function (type, options) {
        ...
        (Lobibox.notify.DEFAULTS = {
            title: !0,
            size: "normal",          
            soundPath: "/Dashtrans/assets/plugins/notifications/sounds/",
            soundExt: ".ogg",
